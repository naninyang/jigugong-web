...
const OriginCite = styled.strong({
  fontWeight: fontWeights.SemiBold,
});
  ...
  return (
    <>
      <Head>
        ...
        <title key='title'>지구공 : 완료된 미션 [내 용기는 이만큼 커!]</title>
      ...
      <Container data-container='article'>
        ...
        <PageHeading link={'/missions'} label={'완료된 미션'} />
        <Contents>
            ...
            <CommentItem>
              ...
              <ReplyList>
                ...
                <ReplyItem>
                  ...
                  <AsideDescription>
                    <p><OriginCite>@먀오오</OriginCite> 안녕하세요 안녕하세요 안녕하세요 안녕하세요 안녕하세요</p>
                    <p>안녕하세요 안녕하세요 안녕하세요 안녕하세요 안녕하세요 안녕하세요</p>
                  </AsideDescription>
                  <AsideOptions>
                    <AsideOptionLike>
